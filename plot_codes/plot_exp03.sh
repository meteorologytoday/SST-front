...
fig_dir=figures_exp02_compare_ML_and_bl_scheme_front
...
for _ML in "wML" "woML"; do
    ...
    for _bl_scheme in "YSU" "MYNN3"; do
        ...
        input_file=../03_SST_front/lab_front/case_dT300_wid050_${_ML}_${_bl_scheme}/wrfout_d01_0001-01-01_00\:00\:00
